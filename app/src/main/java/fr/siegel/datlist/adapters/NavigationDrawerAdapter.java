...
public class NavigationDrawerAdapter extends RecyclerView.Adapter<NavigationDrawerAdapter.ViewHolder> {
    ...
    public int getItemCount() {
        return navigationTitles.length + 1; // the number of items in the list will be +1 the titles including the header view.
    }
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View itemView, int ViewType) {                 // Creating ViewHolder Constructor with View and viewType As a parameter
            ...
            if (ViewType == TYPE_ITEM) {
                textView = (TextView) itemView.findViewById(R.id.navigationDrawerTitle); // Creating TextView object with the id of textView from item_row.xml
                imageView = (ImageView) itemView.findViewById(R.id.navigationDrawerIcon);// Creating ImageView object with the id of ImageView from item_row.xml
